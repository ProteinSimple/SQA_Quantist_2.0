...
def Test1():
  Regions.Selected_Analytes_moved_down.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr)

def Test2():
  Regions.moved_down_NEW.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr)

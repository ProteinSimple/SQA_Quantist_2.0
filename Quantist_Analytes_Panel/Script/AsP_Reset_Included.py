...
def Analytes_Panel_Reset_Included():
  ...
  mainWindowView.Click(790, 87) # Include check/uncheck first row 
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
  mainWindowView.Click(790, 97) # Include check/uncheck second row
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
  mainWindowView.Click(790, 122) # Include check/uncheck third row
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
  mainWindowView.Click(790, 140) # Include check/uncheck fourth row
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
  mainWindowView.Click(790, 160) # Include check/uncheck fifth row
  ...
  CommonUnit.NotePad_SaveToFile("AP_Copy_Uncheck_All.txt")
  ...
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
  Aliases.Quantist.MainWindowView.RunTreeView.Click(158, 255) #turn off highlighted button for comparision
...
def Test1():
  Regions.Uncheck_Included2.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr)

def Test2():
  Regions.Check_Included_Reset2.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr)

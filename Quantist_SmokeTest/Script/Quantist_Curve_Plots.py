...
def Config_Current_Curve_Analyte(CurveFit, CurveWeight, RecoveryRange, CurveData, CurveImage):
  ...
  ProjectSuite.Variables.Short_Delay
  Aliases.Quantist.MainWindowView.MainView.CurvePanel.ConfigureCurve.CurveFitBox.ClickItem(CurveFit)
  Aliases.Quantist.MainWindowView.MainView.CurvePanel.ConfigureCurve.CurveWeightingBox.ClickItem(CurveWeight)
  Aliases.Quantist.MainWindowView.MainView.CurvePanel.ConfigureCurve.RecoverRangeBox.ClickItem(RecoveryRange)
  ...
  graph_canvas2 = Aliases.Quantist.MainWindowView.MainView.CurvePanel.GroupboxCurrentCurveData # The CurveData object 
...
def New_Combo_Box():
  groupBox = Aliases.Quantist.MainWindowView.MainView.CurvePanel.ConfigureCurve
  comboBox = groupBox.CurveFitBox
  comboBox.ClickItem("FivePL")
  
  comboBox = groupBox.CurveWeightingBox
  comboBox.ClickItem("OneOverY")
  
  comboBox = groupBox.ConcCVLim
  comboBox.ClickItem("LessThanOrEqualTo25Percent")
  comboBox.ClickItem("LessThanOrEqualTo5Percent")
  comboBox.ClickItem("LessThanOrEqualTo20Percent")
  
  comboBox = groupBox.RecoverRangeBox

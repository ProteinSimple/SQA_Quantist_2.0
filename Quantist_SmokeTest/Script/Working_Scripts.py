def Launch_Write_To_Notepad():

  Log.Message("code below works ok!")  
  ...
  #edit = wndNotepad.Edit  <=== to write to Notepad

  #edit.Keys("Installation Directory: " + installDir)
  #edit.Keys("\n")
  #edit.Keys("DUC is here")
  ...
  #comboBox.SetText("Quantist_Installation_Files1")
...
def Test8():
  ...
  OCR.Recognize(explorer.wndMultitaskingViewFrame).BlockByText("9 Python strftime() - datetime to string -- X").Click(-1, -1, skAlt)
  Aliases.notepad.wndNotepad.Minimize()
  explorer.wndShell_TrayWnd.ReBarWindow32.MSTaskSwWClass.MSTaskListWClass.Click(121, 16)
  explorer.wndTaskListThumbnailWnd.Click(645, 89)
  Browsers.Item[btChrome].Navigate("https://www.programiz.com/python-programming/datetime/strftime")
  page = Aliases.browser.pagePythonStrftimeDatetimeToStri
  page.textnodePythonIntroduction.Click(235, 27)
  page.linkGettingStarted.Click()
  OCR.Recognize(page).BlockByText("Close").Click()

def Test9():
  explorer = Aliases.explorer
  explorer.wndShell_TrayWnd.ReBarWindow32.MSTaskSwWClass.MSTaskListWClass.Click(131, 17)
  Aliases.browser.BrowserWindow.Click(520, 17)
  Browsers.Item[btChrome].Navigate("https://www.google.com/")

def Test10():
  browser = Aliases.browser
  browser.BrowserWindow.Click(520, 19)
  Browsers.Item[btChrome].Navigate("https://www.google.com/")
  textbox = browser.pageGoogle.formSearch.textboxQ
  textbox.Click(133, 23)
  textbox.SetText("TestComplete tutorial")
  textbox.Keys("[Enter]")
  page = browser.pageSearch
  page.Wait()
  page.textnodeTestcompleteFromSmartbea.Click(326, 17)
  page = browser.pageSmartbearComProductTestcompl
  page.Wait()
  aqObject.CheckProperty(Aliases.browser.pageSmartbearComProductTestcompl.form.navFeatures.linkOverview.imageTcWordmarkClrSvgExtSvg, "contentText", cmpEqual, "")
  Regions.smartbear_logo.Check(Aliases.browser.pageSmartbearComProductTestcompl.form.headerPLtHeader.navProducts.linkSmartbearCom.vgLayer1)
  page.buttonStartMyFreeTrial.ClickButton()
  aqObject.CheckProperty(Aliases.browser.pageSmartbearComProductTestcompl.form.panel, "contentText", cmpEqual, 'Easily build and automate functional UI tests for Desktop, Mobile, and Web applications.\n30 Days Free\nUse Record & Replay or script in 7 languages to easily create tests\nAccess to 500+ remote environments to expand test coverage\nData-driven, regression, & parallel testing capabilities to scale quickly\n\"We have reduced the overall average application testing timeline from several weeks down to several hours. That means software improvements go into production faster, and the quality of software has also increased significantly.\"\nLulia Meladze\nHead of Quality Assurance Team, TBC Bank')

...
def Verify_5PL_Unknowns_BK():
  ...
  #treeListView = mainWindowView.GridData
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
  Aliases.Quantist.MainApp.MainWindow.GridData.Use_Col.DblClick()
...
def Verify_5PL_Unknown():

#  main = Aliases.Quantist.MainWindowView  
#  treeView = Aliases.Quantist.MainWindowView.RunVerify_5PL_UnknownsTreeView
#  
#  flag = True
#  while (treeView.HasItems):
...
#  aqUtils.Delay(ProjectSuite.Variables.Short_Delay) 
  ...
  while (i < 1):
    ...
    #rowMarginControl = treeListView.RowMarginControl
    rowMarginControl = treeListView.row_1
    
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    netMFI_2  = grid.netMFI_2.DisplayText
    ...
    rowMarginControl = treeListView.row_2
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_3
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_4
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_5
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_6
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_7
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_8
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_9
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText
    ...
    rowMarginControl = treeListView.row_10
    rowMarginControl.Click(10, 10)
    conc_1    = grid.conc_1.DisplayText
    netMFI_1  = grid.netMFI_1.DisplayText
    conc_2    = grid.conc_2.DisplayText

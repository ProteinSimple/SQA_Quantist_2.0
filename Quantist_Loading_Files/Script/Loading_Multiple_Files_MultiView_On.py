...
def Loading_Multiple_Files_MultiView_On():
  ...
  Regions.LoadingFiles_MultiView_enabled_TreeView.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr.Border2)
  Regions.LoadingFiles_MultiView_enabled_MainView.Check(Aliases.Quantist.MainWindowView.MainView)

  hwndSource = Aliases.Quantist.MainWindowView
  hwndSource.CollapseButton.ClickButton()
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
    
  Regions.LoadingFiles_MultiView_enabled_TreeView_collapse.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr.Border2)
  hwndSource.ToggleShareView.ClickButton(cbUnchecked)
  aqUtils.Delay(ProjectSuite.Variables.Short_Delay)
    
  Regions.LoadingFiles_MultiView_disabled_TreeView.Check(Aliases.Quantist.MainWindowView.MainViewRunCtr.Border2)
  Regions.LoadingFiles_MultiView_disabled_MainView.Check(Aliases.Quantist.MainWindowView.MainView)
